        ...
        <tr>
            ...
            <td>
                <select name="user_agent">
                    <option <?php echo $user_agent != 'yes' ? 'selected="selected"' : '' ?>
...
function couponxl_is_plugin_active( $plugin ) {
        ...
        <div class="comment-inner clearfix">
            ...
            <div class="media-body comment-body">
                <div class="pull-left">
                    ...
                    <span><?php echo human_time_diff( get_comment_date(), current_time( 'mysql' ) ) . __( ' ago', 'couponxl' ); ?></span>
                </div>
...
function couponxl_ratings_box() {
	...
	foreach ( $screens as $screen ) {
		add_meta_box( 'couponxl_ratings', __( 'Manage Ratings', 'couponxl' ), 'couponxl_ratings_box_populate', $screen );
	}
}
...
include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
if ( is_plugin_active( 'couponxl-cpt/couponxl-cpt.php' ) ) {
